  ...
  return (
    <nav className="bg-green-500 fixed w-full  text-white h-14 flex items-center">
      <section className="w-[80%] m-auto flex justify-between items-center ">
        ...
        <ul
          className={`flex gap-5 max-md:flex-col max-md:fixed right-0 bottom-0 top-14 max-md:w-[240px] max-md:h-auto max-md:bg-green-400 max-md:gap-0 max-sm:items-start 
